...
<header class="header-top">
    <div class="container align-right">
        <ul>
            ...
            <li>
                <img src="{{asset('assets/images/mail-icon.png')}}" alt=""> <a href="mailto:contact@ramaply.com"> contact@ramaply.com</a>
            </li>
        </ul>
    </div>
</header>
                ...
                <div class="mega-menu  productmega-menu">
                    <div class="flex">
                        ...
                        <div class="mega-menu-inside">
                            <h3><a href="{{url('products')}}/{{$singleinfo['slug']}}">{{$singleinfo->name}}</a></h3>
...
<footer class="footer">
    <div class="container flex">
        <div class="footer-left">
            <h4>About Ramaply</h4>
            <div class="text">
            RamaPly is today an eminent and trusted name in the Indian domestic panel industry. It has been 50 years since our foray began in 1964. In fact, we take pride in the fact that consistent and dedicated efforts, along with innovative techniques and approach that spans decades, has resulted in the success of Rama Group of companies.
            </div>
        ...
        <div class="footer-last">
           ...
           <!-- <div class="text">
            ...
            <h4>
                ...
                <div class="cor-offi">
                    <p>
                        <span><img src="{{asset('assets/images/footer-loc-icon.png')}}" alt=""></span>Near I.T.I. P.O. Birla Vikas, Satna-485005 (M.P.)

                    </p>
                    <p>
                        <span><img src="{{asset('assets/images/footer-phn-icon.png')}}" alt=""></span>07672-257025, 405555

                    </p>
                    <p>
                        <span><img src="{{asset('assets/images/footer-mail-icon.png')}}" alt=""></span>
                        <a href="mailto:admin@ramaply.com"> admin@ramaply.com  </a>
                    </p>
                </div>
            </div>
            <div class="wrap">
