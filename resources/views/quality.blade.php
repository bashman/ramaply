                ...
                <div class="container">
                        <div class="quanit-tab">
                            ...
                            <ul class="main-ul">
                                   <li class="active">
                                        <div class="feat-tab-icon">
                                            <img src="{{asset('assets/images/features-nor.png')}}" class="nor" alt="">
                                            <img src="{{asset('assets/images/features-hov.png')}}" class="hov" alt="">
                                        </div>
                                        USP
                                    </li><li class="">
                                        <div class="feat-tab-icon">
                                            <img src="{{asset('assets/images/tech-nor.png')}}" class="nor" alt="">
                                            <img src="{{asset('assets/images/tech-hov.png')}}" class="hov" alt="">
                                        </div>
                                        R&D 
                                    </li><li class="">
                                        <div class="feat-tab-icon">
                                            <img src="{{asset('assets/images/certificate-nor.png')}}" class="nor" alt="">
                                            <img src="{{asset('assets/images/certificate-hov.png')}}" class="hov" alt="">
                                        </div>
                                        Certification
                                    </li>
                                </ul>
                            ...
                            <div class="tab-container">
                                <div class="content">
                                    ...
                                    <h4>SDS</h4>
                                    <p style="float:right; margin:20px 0 15px 15px;"><img src="{{asset('assets/images/ssd.png')}}"  alt=""></p>
                                   <p>It is our values...<br>
                                    ...
                                    <hr />
                                    <p style="float:right; margin:20px 0 15px 15px;"> <img src="{{asset('assets/images/vpi.png')}}"  alt=""></p>
                                    <h4>VPI</h4>
                                ...
                                <div class="content">
                                    ...
                                    <div class="flex">
                                        ...
                                        <div class="cont-right">
                                            ...
                                            <div class="item">
                                            <img src="{{asset('assets/images/r-and-d.png')}}"  alt="">
                                            </div>
