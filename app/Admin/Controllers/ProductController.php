    ...
    protected function form($id = null)
    {
        return Admin::form(Product::class, function (Form $form) use ($id) {
            $form->tab('Product', function ($form) {
                ...
                $form->text('specification', trans('Specification'));
                ...
                $form->text('varient', trans('Varient'));
                $form->text('warranty', trans('Warranty / Guarantee'));
                $form->text('sizes', trans('Sizes'));
                ...
                $form->text('specifications', trans('Features'));
