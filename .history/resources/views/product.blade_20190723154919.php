                    ...
                    @if($productfeatures->count() > 0)
                        ...
                        <div class="spc-new">
                           ...
                           if($cntr==1){
                            ...
                            $iconname='Available.png';
                           }elseif($cntr==3){
                            $iconname='Sizes.png';
                           }elseif($cntr==4){
                            $iconname='specification.png';
                           }elseif($cntr==5){
                            $iconname='USP.png';
                           }elseif($cntr==5){
                            $iconname='Warranty.png';
                           }else{
                            $iconname='Application.png';
                           }
                            ...
                            @foreach($productfeatures as $key=>$singleinfo)
                                ...
                                <li class="flex">
                                    <div class="spc-img">
                                        ...
                                        @else
                                            <img src="{{env('APP_URL')}}/assets/images/icons/{{$iconname}}" alt="">
                                        @endif 
                                    </div> 
                                    <div class="spc-txt"><h4>{{$singleinfo->name}}</h4><p>{{$singleinfo->description}}</p></div> 
                                </li>
                                @php 
                                $cntr++;
                               @endphp
