                    ...
                    <ul class="flex-start">
                        ...
                        @if($relatedproduct && $relatedproduct->count() > 0)
                           ...
                           @foreach($relatedproduct as $singleprod)
                                <li><a href="{{url('product')}}/{{$singleprod['slug']}}"><img src="@if($singleprod['thumb']){{asset($singleprod['thumb'])}}@else{{env('APP_URL')}}/productimage/noimg.jpg@endif" alt=""> <p>{{$singleprod->title}}</p></a> </li>
                           @endforeach
                        @endif 
                    </ul>
                    </div>    
