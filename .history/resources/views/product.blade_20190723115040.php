            ...
            <div class="flex">
                <div class="product-left">
                    ...
                    <div class="spc-new">
                        <ul class="flex">
                            <li class="flex">
                                <div class="spc-img"><img src="{{env('APP_URL')}}/assets/images/termite.png" alt=""></div> 
                                <div class="spc-txt"><h4>Termite and Borer Resistant</h4><p>Termite and Borer Resistant</p></div> 
                            </li>
                            <li class="flex">
                                <div class="spc-img"><img src="{{env('APP_URL')}}/assets/images/termite.png" alt=""></div> 
                                <div class="spc-txt"><h4>Termite and Borer Resistant</h4><p>Termite and Borer Resistant</p></div> 
